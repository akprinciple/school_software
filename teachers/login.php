<?php
		...
		if (isset($_POST['submit'])) {
			...
			$sql = "SELECT * FROM register WHERE username = '{$username}' && password = '{$password}' && level = 1 ||  username = '{$username}' && password = '{$password}' && level = 4";
...
<div class="mt-5">
<h2 class="text-center font-weight-bold">TEACHERS' LOGIN</h2>
