        ...
        $tmp = $_FILES['image']['tmp_name'];
         ...
         if ($_FILES["image"]["size"] > 100000) {
                ...
                elseif ($type != "JPG" && $type != "jpg"  && $type != "PNG" && $type != "png") {
                      $msg = "<div class='text-center text-danger p-2 font-weight-bold'>Only jpg and png files are allowed</div>";
                  }
                    else{
                            $id = $_SESSION['id'];
                      ...
                      $msg = "<div class='text-center text-danger p-2 font-weight-bold'>Error</div>";
...
<html>
<head>
	<title>Signatures | Fidelity Schools</title>
	...
	<div class="h-100 pl-3 pr-3">
        ...
        <div class="border w-100">
          ...
          $_SESSION['signature'] = $rw['signature'];
           ...
           <?php } else{  ?>
                  <h1 class='text-center'><s> <?php echo substr($_SESSION['name'], 0, 3); ?></s></h1>
            <?php } ?>
        </div>
         <form method="post" enctype="multipart/form-data">
          <div class="form-group mt-3">
           <input type="file" required="required" placeholder="Upload Signature" accept=".jpg,.png" name="image" class="form-control">
         </div>
