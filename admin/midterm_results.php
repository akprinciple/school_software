...
?>
	...
	while ($row = mysqli_fetch_array($query)) {
	 ...
	 ?>
                        ...
                        <div class="col-md-4">
                            <div class="p-3"></div>
                            <button type="search" name="submit"
                                class="btn btn-success rounded w-100 mt-3">Search</button>
                        </div>
                    </form>
                    ...
                    <div class="col-md-4 form-group p-2">
                        <form>
                            ...
                            <br>
                            <input type="search" required="required" name="search" placeholder="Search By keyword"
                                class="form-control" value="<?php if (isset($_GET['search'])) {
	echo $_GET['search']; } ?>">
...
if (isset($_GET['class']) && isset($_GET['term']) && isset($_GET['subject']) && isset($_GET['session']) && !isset($_GET['edit_all'])) {
	...
	?>
                ...
                <!-- Refresh Button -->
                <a href="midterm_results" class="btn btn-primary  ml-1 mb-1 fas fa-expand-arrows-alt"
 ...
 ?>
 	...
 	?></td>
                                    ...
                                    <td><input type="number" required="required" name="week_test<?php echo $name; ?>"
                                            value="0" class="form-control  text-center " max="20" min="0"></td>
                                    <td><input type="number" required="required" name="test<?php echo $name; ?>"
                                            value="0" class="form-control  text-center " max="20" min="0"></td>
                                    <td><input type="number" required="required" name="exam<?php echo $name; ?>"
                                            value="0" class="form-control  text-center " max="60" min="0"></td>
                                    <!-- <td>0</td> -->
...
// What will be displayed When the results is greater than 0
	...
	?>
                        ...
                        <!-- Refresh Button -->
                        <a href="midterm_results" class="btn btn-primary float-right ml-1 fas fa-expand-arrows-alt"
                            title="Refresh Page"></a>

                        <!-- Button for Deleting Zero scores -->
                        <a
                            href="delete.php?del_zero&class=<?php echo $class; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&&subject=<?php echo $subject; ?>"><button
                                class="btn btn-danger mb-1 float-right ml-1 fas fa-trash-alt"
                                title="Delete Zero Scores"></button></a>
                        <!-- Button Export as CSV -->
                        <a href="export/exportcsv?class=<?php echo $class; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&subject=<?php echo $subject; ?>"
                            class="btn btn-info text-light float-right ml-1 mb-1 fas fa-file-excel"
                            title="Export as Csv"></a>

                        <!-- Button To Edit All results -->
                        <a href="?edit_all&class=<?php echo $class; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&subject=<?php echo $subject; ?>"
                            class="btn btn-warning text-light float-right mb-1 fas fa-pen" title="Edit all results"></a>
                        <!-- Button to add score for new student -->
                        <a id="click" class="pointer btn btn-success fas fa-plus mr-1 float-right"
                            title="Add score for new Student"></a>
                        <div class="clearfix"></div>
	...
	?>
                        ...
                        <div id="reg" class="col-md-11 m-auto shadow p-2 bg-white rounded bot-left border-success"
                            style="display: none;">
	...
	?>
                                                <option value="<?php echo $rel['user_id']; ?>" style="<?php  
	...
	?>
                                    ...
                                    <div class="col-md-6 mt-2">
                                        ...
                                        <input type="number" name="test2" min="0" max="20" class="form-control"
                                            placeholder="Input Weekly Test Score">
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label class="font-weight-bold">Midterm Test(20)</label>
                                        <input type="number" name="test" min="0" max="20" class="form-control"
                                            placeholder="Input Midterm Test Score">
                                    </div>
                                    <div class="col-md-6 mt-2">
                                        <label class="font-weight-bold">Exam(60)</label>
                                        <input type="number" name="exam" min="0" max="60" class="form-control"
                                            placeholder="Input Exam Score">
                                    </div>

                                    <div class="col-md-6"></div>
                                    <div class="col-md-6 mt-2">
                                        <button type="submit" name="add"
                                            class="btn btn-success w-100 mt-4 mx-auto d-block">Add</button>
                                    </div>
                                </div>
                            </form>
                        </div>
...
?>
	...
	?>
                                        ...
                                        <td>
                                            <span id="update<?php echo $report['id']; ?>" title="Edit Scores"
                                                class="fas fa-pen pointer text-success"></span>
                                            <span id="del<?php echo $report['id']; ?>" title="Delete"
                                                class="fas fa-times text-danger"></span>
                                        </td>
                                    </tr>
...
$show = mysqli_query($connect, $select);
	...
	?>
                                    ...
                                    <!-- Refresh Button -->
                                    <a href="midterm_results"
                                        class="btn btn-primary float-right ml-1 mb-1 fas fa-expand-arrows-alt"
                                        title="Refresh Page"></a>
                                    <!-- Button To Go back to results -->
                                    <a href="?class=<?php echo $class; ?>&session=<?php echo $session; ?>&term=<?php echo $term; ?>&subject=<?php echo $subject; ?>"
                                        class="btn btn-warning text-light float-right mb-1 fas fa-step-backward"
                                        title="Go back"></a>
                                    <div class="clearfix"></div>
                                    ...
                                    <div class="row  text-center mx-0 mb-n3">
                                        <div class="col-md-6 my-0 p-0">
                                            <div
                                                class="float-left w-50 shadow bg-success text-light p-2 font-weight-bold mb-3">
	...
	?>
                                            ...
                                            <!---------------- Term Display  --------------->
                                            <div
                                                class="float-right w-50 bg-white text-dark p-2 font-weight-bold shadow mb-3">
                                                <?php
	...
	?> Term
                                        ...
                                        <div class="col-md-6 my-0 p-0">
                                            <div
                                                class="float-left w-50 shadow bg-white txt-light p-2 font-weight-bold mb-3">
                                                <!-- Class: -->
                                                <?php 
	$c_sql = "SELECT * FROM class WHERE id = '{$class}'";
	$c_query = mysqli_query($connect, $c_sql);
 	...
 	while ($pro = mysqli_fetch_array($s_name)) {
		...
		?></td>
                                                ...
                                                <td><input type="number" required="required"
                                                        name="week_test<?php echo $name; ?>"
                                                        value="<?php echo $r_name['test2']; ?>"
                                                        class="form-control  text-center " max="20" min="0"></td>
                                                <td><input type="number" required="required"
                                                        name="test<?php echo $name; ?>"
                                                        value="<?php echo $r_name['test']; ?>"
                                                        class="form-control  text-center " max="20" min="0"></td>
                                                <td><input type="number" required="required"
                                                        name="exam<?php echo $name; ?>"
                                                        value="<?php echo $r_name['exam']; ?>"
                                                        class="form-control  text-center " max="60" min="0"></td>
 ...
 if (isset($_POST['edit_all'])) {
	...
	if ($i_query) {
		...
		header('location: midterm_results?class='.$class.'&term='.$term.'&&subject='.$subject.'&&session='.$session.'');
                                        ...
                                        <button type="submit" name="edit_all"
                                            class="btn btn-success float-right my-3">Update All</button>
                                    </form>
...
?>
                                        ...
                                        <form method="post" enctype="multipart/form-data">
                                            <div class="text-center"><b>Keyword:</b> <?php echo $_GET['search']; ?>
                                            </div>
                                            <table
                                                class="table-bordered table-striped table col-md-12 text-center mx-auto mb-3 bg-white shadow rounded">
...
?>
            <div id="fetch<?php echo $user['id']; ?>" class="w-100 position-absolute position-fixed"
                style="background-color: rgba(0,0,0,0.5); min-height: 100%; top: 0; z-index: 2; display: none;">
                <div class=" bg-dark w-100 text-light text-center position-absolute p-2" style="bottom: 0; ">Are you
                    sure you want to <b class="text-danger"> DELETE</b> the report for
	...
	?>
		...
		?>
                    ...
                    <a
                        href="delete?midterm_del_report=<?php echo $user['id']; ?>&class=<?php echo $_GET['class']; ?>&term=<?php echo $_GET['term']; ?>&subject=<?php echo $_GET['subject']; ?>&session=<?php echo $_GET['session']; ?>"><button
                            class="btn-success btn">Yes</button></a>
	...
	-->
                    <a
                        href="delete?midterm_del_report_keyword=<?php echo $user['id']; ?>&search=<?php echo $_GET['search']; ?>"><button
                            class="btn-success btn">Yes</button></a>
                    <?php } ?>
...
?>
            ...
            <div id="fetcher<?php echo $user['id']; ?>" class="w-100 position-absolute position-fixed"
                style="background-color: rgba(0,0,0,0.5); min-height: 100%; top: 0; z-index: 2; display: none;">
                <div class="col-md-8 m-auto p-5 shadow">
                    <span id="clearer<?php echo $user['id']; ?>"
                        class="fas fa-times text-danger float-right fa-2x"></span>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6 px-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number" max="20" min="0" required="required"
                                            name="w_test<?php echo $id; ?>" value="<?php echo $user['test2'] ?>"
                                ...
                                <div class="col-md-6 px-3">
                                    ...
                                    <div class="form-group">
                                        <input type="number" max="20" min="0" required="required"
                                            name="test<?php echo $id; ?>" value="<?php echo $user['test'] ?>"
                                            class="text-center form-control">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <label>Exam(60)</label>
                                    <div class="form-group">
                                        <input type="number" max="60" min="0" required="required"
                                            name="exam<?php echo $id; ?>" value="<?php echo $user['exam'] ?>"
                                            class="text-center form-control">
                                    </div>
                                </div>
                                <div class="w-50 pt-4 px-3">
                                    <button type="submit" name="ind_update<?php echo $id; ?>"
