...
$delimiter = ",";
$filename = $subject_row['subject']."_".$class_row['class']."_".$term_row['term']."_".$session_row['session'].".csv";

// Create a file pointer
$f = fopen('php://memory', 'w');

// Set column headers
$fields = array('S/N', 'STUDENT ID','NAME', 'SUBJECT', 'TERM', 'CLASS', 'SESSION', 'WEEKLT TEST', 'MIDTERM TEST', 'EXAM SCORE');
...
$lineData = array($n++, $row['student_id'], $name['name'], $row['subject'], $row['term'], $row['class'], $row['session'], $row['test2'], $row['test'], $row['exam']);
