...
<select name="material" class="form-control text-center" onchange="finder(this.value)">
	<option class="text-center">Select Class</option>
	<option value="all">General</option>
	<?php
		$sql = mysqli_query($connect, "SELECT * FROM class ORDER BY class ASC");
...
<?php  
$sel = "SELECT * FROM class ORDER BY id ASC";
$selt = mysqli_query($connect, $sel);
$n = 1;
