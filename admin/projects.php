...
<!-- <span class="">/</span> -->
<a href="projects" class="text-success fas fa-expand-arrows-alt" title="Refresh Page"></a>
</span>	
...
<tbody>
<?php 
$sel = "SELECT * FROM projects ORDER BY id DESC";
$selt = mysqli_query($connect, $sel);
$n = 1;
...
<td class="">
<a href="approve?approve_proj=<?php echo $rw['id']; ?>" title="<?php if($rw['status'] == 1){echo "click to Unapprove";}else{echo "Click to Approve";} ?>"><button class="fas fa-check btn p-1 
		<?php if($rw['status'] == 1){echo "btn-success";}else{echo "btn-warning";} ?>"></button></a>
<span title="Delete" id="del<?php echo $rw['id']; ?>" class="fas fa-times text-danger pointer"></span></td>
</tr>
<?php } ?>	
</tbody>
</table>
 ...
 <?php 
 $u_sql = "SELECT * FROM projects ORDER BY id DESC";
...
<a href="delete?del_project=<?php echo $user['id']; ?>">
	<!-- <button class="btn-success btn">Yes</button> -->
	<button type="button" class="btn btn-success">yes</button>
	
</a>
<span id="clear<?php echo $user['id']; ?>">
