...
<div class="row">
	...
	<div class="col-md-4">
		...
		<div class="form-group">
			...
			<input type="search" name="search" value="<?php if(isset($_GET['search'])){echo $_GET['search'];} ?>" class="form-control" placeholder="Search by keyword">
			<button class="btn btn-success float-right mt-2">Search</button>
		<div class="clearfix"></div>
		</div>
	</form>
...
<div class=" bg-dark w-100 text-light text-center position-absolute p-2" style="bottom: 0; ">Are you sure you want to delete <b> <?php echo $user['name']; ?> </b> Project permanently?
