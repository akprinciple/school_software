...
<div class="col-md-6 mt-2">
	<label class="font-weight-bold">Second CA (20)</label>
...
<form method="post" enctype="multipart/form-data">
<h5 class="text-center"><b>Keyword : </b><?php echo $search; ?></h5>
...
$u_sql = "SELECT * FROM arabic_result WHERE class= '$class' && term = '$term' && subject = '$subject' && session = '$session'";
